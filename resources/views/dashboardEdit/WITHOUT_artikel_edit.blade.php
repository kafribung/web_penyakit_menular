...
@section('title', 'Artikel Edit Tanpa Logins | Kafri Bung')
@section('content')
                    ...
                    <div class="card-body ">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="box-title text-center">Edit Artikel Tanpa Login</h4>
                            </div>
                            <div class="card-body">
                                <form action="/artikel-without-route/{{$artikel->id}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
