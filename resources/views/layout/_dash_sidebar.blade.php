    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                @if (Request::segment(1) == 'artikel-without-route')
                    <li class="menu-title">Artikel</li>
                    <!-- /.menu-title -->
                    <li class="{{ Request()->is('artikel-without-route')  ? 'active' : '' }}">
                        <a href="/artikel-without-route"> <i class="menu-icon ti-write"></i>All Artikel</a>
                    </li>

                    <li class="{{ Request()->is('artikel-without-route/create') ? 'active' : ''}}">
                        <a href="/artikel-without-route/create"> <i class="menu-icon ti-marker-alt"></i>Add Artikel</a>
                    </li>
