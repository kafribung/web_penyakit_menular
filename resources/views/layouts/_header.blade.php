        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-6 ml-auto d-flex">
                <div class="ml-md-auto top-social d-none d-lg-inline-block">
                    ...
                    <a href="" target="_blank" class="d-inline-block p-3"><span class="icon-github"></span></a>
                    <a href="https://www.facebook.com/KafriTaziu" target="_blank" class="d-inline-block p-3"><span class="icon-facebook"></span></a>
                </div>
                ...
                <div class="mr-auto">
                    <nav class="site-navigation position-relative text-right" role="navigation">
                        <ul class="site-menu main-menu js-clone-nav mr-auto d-none pl-0 d-lg-block">
                            ...
                            <li>
                                <b><a href="/login" class="nav-link text-left">Dash (Login)</a></b>
                            </li>

                            <li>
                                <b><a href="/artikel-without-route" class="nav-link text-left">Dash (No Login)</a></b>
                            </li>

                            <li>
                                <b><a href="/register" class="nav-link text-left">Register</a></b>
                            </li>
                        </ul>
                    </nav>
