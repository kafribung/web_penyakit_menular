...
@section('title', 'Artikel Tanpa Login | Kafri Bung')
@section('content')
                    ...
                    <aside class="profile-nav alt">
                        <section class="card">
                            ...
                            <div class="card-text text-sm-center">
                                <a href="/artikel-without-route/{{$artikel->id}}/edit" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

                                <form action="/artikel-without-route/{{$artikel->id}}" method="POST" class="d-inline-flex">
                                    @csrf
                                    @method('DELETE')
